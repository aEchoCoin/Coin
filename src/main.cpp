...
uint256 hashGenesisBlock("0x261a37c86f2fbcb38d05fb7ac3d9fec2de8d0fba14ddd7407e431e6d278a503c");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // aEchoCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "aEchoCoin Signed Message:\n";
...
{
    // aEchoCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 108000;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // aEchoCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // aEchoCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // aEchoCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x261a37c86f2fbcb38d05fb7ac3d9fec2de8d0fba14ddd7407e431e6d278a503c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1423419329;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084675201;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("aEchoCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("aEchoCoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running aEchoCoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("aEchoCoinMiner terminated\n");
        throw;
    }
}
